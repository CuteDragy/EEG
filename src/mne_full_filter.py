...
# [NEW] Deployment Mode Output: Print the extracted features cleanly to the server console.
# This makes it easy to read logs or pipe the data into another backend process.
print("\n[DEPLOYMENT MODE] Feature Extraction Summary:")
print(json.dumps(final_features, indent=4))